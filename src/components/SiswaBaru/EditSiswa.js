                ...
                <div className="columns is-centered mt-5">
                    <div className="column is-half">
                        <form onSubmit={updateSiswa}>
                            <div className="field">
                                <label className="label font-bold">Siswa Name</label>
                            ...
                            <div className="field">
                                <div className="control">
                                    <button type="submit" className="button bg-primary mt-2 py-1 px-2 text-white rounded-lg">
                                        Update
                                    </button>
