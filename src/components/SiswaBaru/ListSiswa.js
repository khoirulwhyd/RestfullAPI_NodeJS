    ...
    return(
        <div className="flex">
            ...
            <div className="container mx-auto mt-12 ml-4 mr-4 font-poppins">
                <div className="py-4">
                    <Link to="/siswa/addsiswa" className="button bg-yellow-500 text-white px-4 py-2 rounded-lg mb-10 hover:bg-yellow-300">
                        Tambah Siswa Baru
                    </Link>
                </div>
                        ...
                        <tbody>
                            <tr class="bg-white border-b" key={siswa.id}>
                                ...
                                <td class=" items-center">
                                    <Link to={`editsiswa/${siswa.id}`} className="button bg-yellow-500 text-white px-2 py-2 rounded-lg hover:bg-yellow-300">
                                        Edit
                                    </Link>
                                    <a
